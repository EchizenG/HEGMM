...
def main():
  ...
  parser.add_argument('--traceMemo', type=bool, default=True, help='trace memory or not, if trace, time is longer than usual')

  args = parser.parse_args()
  LOG_FORMAT = "%(asctime)s - %(levelname)s - %(message)s"
  logging.basicConfig(filename='test11.log', level=logging.DEBUG, format=LOG_FORMAT)
